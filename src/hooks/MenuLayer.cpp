...
class $modify(HHGDMenuLayer, MenuLayer)
{
    bool init() {
        ...
        auto closeMenu = static_cast<CCMenu*>(this
            ->getChildByID("close-menu"));
        auto rightSideMenu = static_cast<CCMenu*>(this
            ->getChildByID("right-side-menu"));
        ...
        auto closeButton = static_cast<CCMenuItemSpriteExtra*>(closeMenu
            ->getChildByID("close-button"));
        ...
        closeButton
            ->setSprite(closeButtonSprite);
        restartButton
            ->setID("restart-button"_spr);
        closeMenu
            ->addChild(restartButton);

        hhgdButton
            ->setID("hhgd-button"_spr);
        rightSideMenu
            ->addChild(hhgdButton);
